...
-----------------------------------------------
  AUTHER   :::     ALEY KASHAN
 FACEBOOK  :::     ALEY KASHAN
 KING     :::     WWK OWNER
    KING OF FACEBOOK ALEY
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/badboy/aley/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://www.facebook.com/Termuxmaster.Aley.2021')
        reg()
